...
.. image:: img/my_nucleo_h745zi_q.jpg
   :width: 720px
   :align: center
   :height: 560px
   :alt: Nucleo H745ZI-Q
...
The Zephyr my_nucleo_h745zi_q board configuration supports the following hardware
features:
...
``boards/arm/my_nucleo_h745zi_q/my_nucleo_h745zi_q_m7_defconfig`` and
``boards/arm/my_nucleo_h745zi_q/my_nucleo_h745zi_q_m4_defconfig``
...
Applications for the ``my_nucleo_h745zi_q`` board should be built per core target,
using either ``my_nucleo_h745zi_q_m7`` or ```my_nucleo_h745zi_q_m4`` as the target
...
.. code-block:: console
   ...
   $ Hello World! my_nucleo_h745zi_q_m7
